...
import com.kdgz.uwifi.auth.util.CsvOperateUtil;
...
public class BaseController extends Controller {
	...
	public BaseController() {
		...
		property = CacheKit.get(Constants.DATACACHE, "property", new IDataLoader() {
...
//				getAdLogProcessors());
	...
	protected CellProcessor[] getRouterLogProcessors() {
	...
	protected CellProcessor[] getAppDownLoadLogProcessors() {
